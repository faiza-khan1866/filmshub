...
const ContactForm = () => {
  ...
  return (
    <>
      <div className="contact_form_sec py-5">
            ...
            <div className="col">
              <div data-aos="zoom-in-down">
                ...
                <ul className="list-unstyled">
                  <li>
                    <FaEnvelope className="icon_style" />
                    <a href="mailto:filmfusion@gmail.com">
                      filmfusion@gmail.com
                    </a>
                  </li>
                  <li>
                    <FaPhoneAlt className="icon_style" />
                    <a href="tel:+xxxxxxxxxxxx">+xxx xx xxx xxxx</a>
                  </li>
                  <li>
                    <FaMapMarkerAlt className="icon_style" />1 Decisive Business
                    Hub, First Floor, Baysquare Building 3, Business Bay, Dubai
                  </li>
                </ul>
              </div>
            </div>
