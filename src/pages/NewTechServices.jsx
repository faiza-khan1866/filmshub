...
import NewTechServicesInfo from "../components/NewTechServices/NewTechServicesInfo";
import NewTechServicesList from "../components/NewTechServices/NewTechServicesList";
...
const NewTechServices = () => {
  ...
  return (
    <>
      <Helmet>
        <title>New Tech Services | Film Fusion</title>
      ...
      <CommonBanner
        ...
        indexpage="HOME"
        indexvisit="/"
        activepage="New Tech Services"
        bgImg={bannerImg}
      />
      <NewTechServicesInfo />
      <NewTechServicesList
        ntservicesList={servicesData}
        isLoading={isLoading}
