...
import AdvertisingServicesDetails from "../components/AdvertisingServicesInner/AdvertisingServicesDetails";
import WhyChooseUs from "../components/PortfolioInner/WhyChooseUs";
import AdvertisingServicesHighlights from "../components/AdvertisingServicesInner/AdvertisingServicesHighlights";
// import FaqSection from "../components/common/FaqSection";
import ConnectWithUs from "../components/common/ConnectWithUs";
import bannerImg from "../images/banners/aboutbanner.png";

const AdvertisingServicesInner = () => {
  const { id } = useParams();
  ...
  return (
    <>
      <Helmet>
        <title>
          {singleServiceData?.seo_tags?.title ??
            "Advertising Service Details | Film Fusion"}
        </title>
        <meta
          name="description"
      ...
      <CommonBanner
        name={singleServiceData?.name ?? "Advertising Service Details"}
        indexpage="HOME"
        indexvisit="/"
        activepage={singleServiceData?.name ?? "Advertising Service Details"}
        bgImg={bannerImg}
      />
      <Loader isLoading={isLoading}>
        <AdvertisingServicesDetails
          moreServiceDetailsData1={
        ...
        <WhyChooseUs
          ...
          ImgBaseUrl={ImgBaseUrl}
        />
        <AdvertisingServicesHighlights
          morehighlightsData={singleServiceData?.highlights}
          ImgBaseUrl={ImgBaseUrl}
        />
      </Loader>
      <ConnectWithUs />
...
export default memo(AdvertisingServicesInner);
